	...
	public function get_collection_params(): array {
		return [
			[
				...
				'param_name'  => $this->collection->get_param_prefix() . '_horizontal',
			...
			[
				...
				'param_name'  => $this->collection->get_param_prefix() . '_vertical',
				'title'       => esc_html__( 'px', 'joywp-testimonials-wpbakery-addons' ),
			...
			[
				...
				'param_name'  => $this->collection->get_param_prefix() . '_blur',
				'title'       => esc_html__( 'px', 'joywp-testimonials-wpbakery-addons' ),
			...
			[
				...
				'param_name'  => $this->collection->get_param_prefix() . '_spread',
				'title'       => esc_html__( 'px', 'joywp-testimonials-wpbakery-addons' ),
